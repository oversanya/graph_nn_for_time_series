                ...
                for d in cfg["datasets"]:
                    ...
                    for v in variants:
                        ...
                        if v=="Base":
                            ...
                            model = DLinearHyper(history, horizon, d_hyper_hidden, n_input=n_channels, d_embedding=d_embedding, embedding=embedding)
                        ...
                        folder = "{}_{}_DLinear_{}_d_{}_e_{}_s_{}".format(
                            date, time, variants_str, datasets_str, epochs, seeds_str
                        )
                        filename = "{}-{}_DLinear_{}_s-{}_{}_{}_{}_e-{}_L-{}_H-{}_bs-{}_lr-{}_hh-{}_emb-{}.pt".format(
                            date,
                            time,
                            v,
                            seed,
